...
\newtoggle{isitlq}
\toggletrue{isitlq}
\newtoggle{usenewuseproblem}
\togglefalse{usenewuseproblem}
...
\newcommand{\giveScore}[1]{{\hfill\color{red}(#1A)}}
\newcommand{\giveMA}{{\hfill\color{red}(1M+1A)}}

\newcommand{\src}[1]{(\color{teal}\textbf{ref:} #1)}
...
\newcommand{\newprob}[3]{
    ...
    \begin{defproblem}{#1}%
        ...
        \begin{onlysolution}%
            % #3
            \iftoggle{usenewuseproblem}{
                \iftoggle{isitlq}{\sol #3}{\mckey #3}
            }{#3}
